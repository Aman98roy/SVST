...
import { Calendar, MapPin, Users, Heart, Sparkles, BookOpen, Leaf } from "lucide-react";
import { YogaImageSlider } from "./yoga-image-slider";
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
            ...
            >
              ...
              >
                Swami Vivekanand Seva Trust, Hingoli
              </motion.p>
            </motion.div>
            ...
            <div className="lg:col-span-2 grid grid-cols-2 gap-4">
              ...
              >
                <div className="flex flex-col items-center text-center">
                  <div className="w-16 h-16 bg-blue-500/30 backdrop-blur-sm rounded-xl flex items-center justify-center mb-4 border border-blue-400/30">
                    <Calendar className="w-8 h-8 text-blue-200" />
                  </div>
                  <h3 className="text-white font-bold text-base mb-2">Date</h3>
                  <p className="text-white text-2xl font-bold">June 21</p>
                </div>
              </motion.div>
              ...
              >
                <div className="flex flex-col items-center text-center">
                  <div className="w-16 h-16 bg-green-500/30 backdrop-blur-sm rounded-xl flex items-center justify-center mb-4 border border-green-400/30">
                    <MapPin className="w-8 h-8 text-green-200" />
                  </div>
                  <h3 className="text-white font-bold text-base mb-2">Venue</h3>
                  <p className="text-white text-xl font-bold leading-tight">
                    SVST Training Center, Hingoli
                  </p>
                </div>
              </motion.div>
            </div>
            ...
            <div className="relative bg-gradient-to-br from-white via-gray-50 to-white dark:from-gray-800 dark:via-gray-900 dark:to-gray-800 backdrop-blur-sm rounded-3xl p-10 lg:p-16 shadow-2xl border-2 border-gray-200/50 dark:border-gray-700/50 overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-lg sm:text-xl lg:text-2xl text-gray-700 dark:text-gray-300 leading-relaxed font-light">
                  Swami Vivekanand Seva Trust, Hingoli actively organizes International Yoga Day (June 21) every year to promote health, well-being, and the holistic benefits of yoga, in line with the vision of Swami Vivekananda who emphasized the unity of body, mind, and soul.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="relative bg-gradient-to-br from-primary-500 via-primary-600 to-accent-teal rounded-3xl p-12 lg:p-16 text-center text-white shadow-2xl overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-xl sm:text-2xl text-white/95 mb-10 max-w-3xl mx-auto leading-relaxed font-light">
                  Experience the transformative power of yoga and celebrate the unity of body, mind, and soul with our community.
                </p>
                <motion.div
